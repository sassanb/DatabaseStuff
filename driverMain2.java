...
public class driverMain{
   ...
   try{
     ...
     System.out.println("Publisher Added");
      myStmt.execute("INSERT INTO books.publishers (publisherName) VALUES ('Niko')");
      myRs = myStmt.executeQuery("SELECT * FROM books.publishers ORDER BY publisherName DESC");
      while(myRs.next()){
         System.out.println(myRs.getString("publisherName");
      }

      System.out.println("");
      System.out.println("Publisher Moddified");
      myStmt.execute("UPDATE books.publishers SET publisherName = 'Nikko' WHERE publisherID = 1");
      myRs = myStmt.executeQuery("SELECT * FROM books.publishers WHERE publisherID=1");
      while(myRs.next()){
         System.out.println(myRs.getString("publisherName");
      }
